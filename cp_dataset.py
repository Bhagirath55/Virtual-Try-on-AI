    ...
    def __getitem__(self, index):
        ...
        if self.stage == 'GMM':
           ...
           if self.datamode == 'train':
                warp_path = osp.join(os.getcwd(), 'result', 'GMM', 'train')
           else:
                warp_path = osp.join(os.getcwd(), 'result', 'GMM', 'test')

           # debug print to verify path
           #print("Loading warped cloth:", osp.join(warp_path, 'warp-cloth', im_name))

           # open images
           c = Image.open(osp.join(warp_path, 'warp-cloth', im_name)).convert('RGB')
           cm = Image.open(osp.join(warp_path, 'warp-mask', im_name)).convert('L')
